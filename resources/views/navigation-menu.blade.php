<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (auth()->user()->role == 'admin')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link href="{{ route('partner.index') }}" :active="request()->routeIs('partner.index')">
                            {{ __('Partners') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('resource.index') }}" :active="request()->routeIs('resource.index')">
                {{ __('Resources') }}
            </x-responsive-nav-link>
        </div>
        @if (auth()->user()->role == 'admin')
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link href="{{ route('partner.index') }}" :active="request()->routeIs('partner.index')">
                    {{ __('Partners') }}
                </x-responsive-nav-link>
            </div>
            <div class="pt-2 pb-3 space-y-1">
