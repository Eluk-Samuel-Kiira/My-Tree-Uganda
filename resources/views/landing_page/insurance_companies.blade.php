...
<head>
    ...
    <title>Our Insurance Company Partners</title>
</head>
                ...
                <div class="row no-gutters d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-img">
                        <div class="image-container">
                            <img src="{{asset('storage/Partners/'.$insurance_company->image)}}" class="card-img" alt="Image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted">{{$insurance_company->category}}</h6>
                            <div class="card-text">
                                <p>
                                    {!! $insurance_company->message !!}
                                </p>
...
<div class="d-flex justify-content-center mx-5">
    {{ $insurance_companies->links('pagination::bootstrap-5') }}
</div>
<!--Our friends-->
