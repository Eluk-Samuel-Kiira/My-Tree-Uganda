...
<head>
    ...
    <title>Our Law Firm Partners</title>
</head>
                ...
                <div class="row no-gutters d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-img">
                        <div class="image-container">
                            <img src="{{asset('storage/Partners/'.$law_firm->image)}}" class="card-img" alt="Image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted">{{$law_firm->category}}</h6>
                            <div class="card-text">
                                <p>
                                    {!! $law_firm->message !!}
                                </p>
...
<div class="d-flex justify-content-center mx-5">
    {{ $law_firms->links('pagination::bootstrap-5') }}
</div>
<!--Our friends-->
