...
<head>
    ...
    <title>Our Government Agency Partners</title>
</head>
...
<div class="container mt-4">
    ...
    @if(count($government_agencies) > 0)
                ...
                <div class="row no-gutters d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-img">
                        <div class="image-container">
                            <img src="{{asset('storage/Partners/'.$government_agency->image)}}" class="card-img" alt="Image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted">{{$government_agency->category}}</h6>
                            <div class="card-text">
                                <p>
                                    {!! $government_agency->message !!}
                                </p>
...
<div class="d-flex justify-content-center mx-5">
    {{ $government_agencies->links('pagination::bootstrap-5') }}
</div>
<!--Our friends-->
