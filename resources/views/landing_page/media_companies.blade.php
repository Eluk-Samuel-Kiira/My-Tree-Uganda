...
<head>
    ...
    <title>Our Media Company Partners</title>
</head>
...
<div class="container mt-4">
    ...
    @if(count($media_companies) > 0)
        @foreach($media_companies as $media_company)
                ...
                <div class="row no-gutters d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-img">
                        <div class="image-container">
                            <img src="{{asset('storage/Partners/'.$media_company->image)}}" class="card-img" alt="Image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted">{{$media_company->category}}</h6>
                            <div class="card-text">
                                <p>
                                    {!! $media_company->message !!}
                                </p>
...
<div class="d-flex justify-content-center mx-5">
    {{ $media_companies->links('pagination::bootstrap-5') }}
</div>
<!--Our friends-->
